                    ...
                    >
                        <div className="flex flex-col w-full mb-4">
                            ...
                            <input
                                ...
                                required
                                readOnly // Make it readOnly if auto-filled
                            />
                        </div>
                        <div className="flex flex-col w-full mb-4">
                            <label className="text-lg font-semibold mb-2">
                        ...
                        {message && (
                            <p className={`mt-4 ${message.includes("Failed") || message.includes("Error") ? "text-red-600" : "text-green-600"} text-center font-semibold`}>
                                {message}
                            </p>
                        )}
                    </form>
